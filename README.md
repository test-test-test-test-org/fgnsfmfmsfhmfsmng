...
```
npm create cloudflare@latest -- --template=cloudflare/templates/orange-tooth-36f5
```

## Preview Deployment

A live public deployment of this template is available at [https://orange-tooth-36f5.templates.workers.dev](https://orange-tooth-36f5.templates.workers.dev)
